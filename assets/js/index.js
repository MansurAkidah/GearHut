    ...
    init: function () {
        var viewModel = function () {
            ...
            this.laptopList = ko.observable([
                ...
                { productName: 'LG Gram 17', price: 139900, description: 'Elevate your productivity with the LG Gram 17 - An ultra-lightweight laptop that delivers power and endurance.', image: 'https://cdn.mos.cms.futurecdn.net/GggajARVjXZEc2qeHamATV.jpg', inStock: 1, quantity: 1 },
                { productName: 'Dell G3 15', price: 99900, description: 'Dominate the gaming arena with the Dell G3 15 - A budget-friendly gaming laptop that doesn\'t compromise on performance.', image: 'https://divinetechcomputerske.co.ke/wp-content/uploads/2022/12/DELL.png', inStock: 0, quantity: 1 },
                { productName: 'Acer Swift 5', price: 109900, description: 'Experience portability with the Acer Swift 5 - An ultrathin and lightweight laptop that combines power with elegance.', image: 'https://cdn.uc.assets.prezly.com/c55bb2f8-4599-49bc-b301-ce585d597302/Acer-Swift-5-SF514-55-Standard_01.png', inStock: 1, quantity: 1 },
                { productName: 'HP Omen 15', price: 139900, description: 'Conquer the gaming battlefield with the HP Omen 15 - A gaming laptop that delivers raw power and cutting-edge features.', image: 'https://onetechcomputers.co.ke/wp-content/uploads/2021/11/HP-OMEN-15-Gaming-Laptop-10TH-Gen-in-kenya.jpg', inStock: 1, quantity: 1 },
                { productName: 'Asus VivoBook S15', price: 89900, description: 'Experience style with the Asus VivoBook S15 - A laptop that combines performance with a bold and expressive design.', image: 'https://dlcdnwebimgs.asus.com/gain/418d0f3b-aeef-44a0-81e0-4a68cc46e9f0/', inStock: 1, quantity: 1 },
                { productName: 'Lenovo Yoga C940', price: 129900, description: 'Immerse yourself in versatility with the Lenovo Yoga C940 - A 2-in-1 laptop that adapts to your every need.', image: 'https://m.media-amazon.com/images/I/71fDYa07BZL.jpg', inStock: 1, quantity: 1 },
                { productName: 'Microsoft Surface Laptop Go', price: 69900, description: 'Simplify your life with the Microsoft Surface Laptop Go - A compact and lightweight laptop that doesn\'t compromise on performance.', image: 'https://vividgold.co.ke/wp-content/uploads/2021/04/microsoft-laptop.jpg', inStock: 1, quantity: 1 },
            ]);
